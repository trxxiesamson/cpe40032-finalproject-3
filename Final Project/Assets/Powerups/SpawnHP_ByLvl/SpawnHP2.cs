...
public class SpawnHP2 : MonoBehaviour
{
	// needed for spawning
	[SerializeField]
    ...
    void Start()
    {
        ...
        float randomX = Random.Range (-16.5f, -2.5f);
		float randomY = Random.Range (0.676f, 0.676f);
		float randomZ = Random.Range (44.25f, 28.75f);
    ...
    Vector3 newVec = new Vector3(Random.Range (minX, -2.5f), minY, Random.Range (minZ, 28.75f));
    return newVec;
	} 
}
