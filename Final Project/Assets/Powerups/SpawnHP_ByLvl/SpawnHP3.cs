...
// An object spawner
public class SpawnHP3 : MonoBehaviour
{
	// needed for spawning
	[SerializeField]
    ...
    void Start()
    {
        ...
        float randomX = Random.Range (-34.5f, -10.5f);
		float randomY = Random.Range (0.676f, 0.676f);
		float randomZ = Random.Range (25, 2);
    ...
    Vector3 newVec = new Vector3(Random.Range (minX, -10.5f), minY, Random.Range (minZ, 2));
    return newVec;
	} 
}
